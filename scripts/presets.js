...
export const BUFF_PRESETS = [
  ...
  },
  {
    ...
    label: "BOT.presets.bardicInspiration.label",
    description: "BOT.presets.bardicInspiration.description",
    flag: {
      targetMode: "target",
      fallbackToSelfIfNoTarget: true,
      type: "passive",
  ...
  {
    id: "testReplacementNoStack",
    label: "BOT.presets.testReplacementNoStack.label",
    description: "BOT.presets.testReplacementNoStack.description",
    flag: {
      targetMode: "target",
      fallbackToSelfIfNoTarget: true,
      allowMultipleTargets: true,
