export const BUFF_PRESETS = [
  ...
  {
    id: "testTurnReminderStart",
    label: "BOT.presets.testTurnReminderStart.label",
    description: "BOT.presets.testTurnReminderStart.description",
    flag: {
      targetMode: "target",
      fallbackToSelfIfNoTarget: true,
      type: "passive",
      reminders: {
        enabled: true,
        message: "BOT.presets.testTurnReminderStart.reminder",
        timing: {
          turnStart: true,
        },
        visibility: "gm",
  ...
  {
    id: "testTurnReminderEnd",
    label: "BOT.presets.testTurnReminderEnd.label",
    description: "BOT.presets.testTurnReminderEnd.description",
    flag: {
      targetMode: "target",
      fallbackToSelfIfNoTarget: true,
      type: "passive",
      reminders: {
        enabled: true,
        message: "BOT.presets.testTurnReminderEnd.reminder",
        timing: {
          turnEnd: true,
        },
        visibility: "gm",
  ...
  {
    id: "testTurnSaveStart",
    label: "BOT.presets.testTurnSaveStart.label",
    description: "BOT.presets.testTurnSaveStart.description",
    flag: {
      targetMode: "target",
      fallbackToSelfIfNoTarget: true,
      type: "passive",
  ...
  {
    id: "testTurnSaveEnd",
    label: "BOT.presets.testTurnSaveEnd.label",
    description: "BOT.presets.testTurnSaveEnd.description",
    flag: {
      targetMode: "target",
      fallbackToSelfIfNoTarget: true,
      type: "passive",
