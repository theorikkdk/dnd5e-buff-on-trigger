export const BUFF_PRESETS = [
  ...
  {
    id: "testSaveActivationAdvantage",
    label: "BOT.presets.testSaveActivationAdvantage.label",
    description: "BOT.presets.testSaveActivationAdvantage.description",
    flag: {
      targetMode: "target",
  ...
  {
    id: "testRepeatedSaveDisadvantage",
    label: "BOT.presets.testRepeatedSaveDisadvantage.label",
    description: "BOT.presets.testRepeatedSaveDisadvantage.description",
    flag: {
      targetMode: "target",
      fallbackToSelfIfNoTarget: false,
      type: "passive",
