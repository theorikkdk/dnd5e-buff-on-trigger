export const BUFF_PRESETS = [
  ...
  {
    id: "testEndWhenStatusRemoved",
    label: "BOT.presets.testEndWhenStatusRemoved.label",
    description: "BOT.presets.testEndWhenStatusRemoved.description",
    flag: {
      targetMode: "target",
      type: "passive",
      status: {
  ...
  {
    id: "testStatusRemovedWithoutEndingBuff",
    label: "BOT.presets.testStatusRemovedWithoutEndingBuff.label",
    description: "BOT.presets.testStatusRemovedWithoutEndingBuff.description",
    flag: {
      targetMode: "target",
      type: "passive",
      status: {
