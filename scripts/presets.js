export const BUFF_PRESETS = [
  ...
  {
    id: "testStoredTargetMarkA",
    label: "BOT.presets.testStoredTargetMarkA.label",
    description: "BOT.presets.testStoredTargetMarkA.description",
    flag: {
      targetMode: "self",
      rememberTargetOnActivation: true,
      requireStoredTargetMatch: true,
  ...
  {
    id: "testStoredTargetMarkB",
    label: "BOT.presets.testStoredTargetMarkB.label",
    description: "BOT.presets.testStoredTargetMarkB.description",
    flag: {
      targetMode: "self",
      rememberTargetOnActivation: true,
      requireStoredTargetMatch: true,
